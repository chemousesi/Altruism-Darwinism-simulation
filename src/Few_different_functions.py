...
def reproduct_alone(list_of_agents, prob_of_mutation, required_energy_to_reproduce, cost_of_reproduction): #returns the list of the agents after the reproduction cycle
    ...
    for agent in list_of_agents:
        new_list_of_agents.append(agent)
        print("slt")
        if agent.energy >= required_energy_to_reproduce: #checks if the agent is able to reproduce
            ...
            child.x = agent.x
            child.y = agent.y
            new_list_of_agents.append(child)
            agent.energy = agent.energy - cost_of_reproduction
    return new_list_of_agents
...
def reproduct_with_a_partner(list_of_agents,prob_of_mutation, required_energy_to_reproduce, cost_of_reproduction, distance_to_reproduct, prob_of_being_altruist): #if two agents are close enough they will reproduce, return the list of the agents after the reproduction cycle
    new_list_of_agents = []
    for agent in list_of_agents:
        new_list_of_agents.append(agent)
